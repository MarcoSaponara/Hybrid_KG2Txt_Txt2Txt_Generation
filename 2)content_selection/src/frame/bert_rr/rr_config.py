...
QUERY_TYPE_WIKI = 'masked_query_with_sub'
if QUERY_TYPE_WIKI in (config.QUERY, config.NARR, config.TITLE):  # omit typical query type for DUC
    RR_MODEL_NAME_BERT_WIKI = f'rr-{BERT_TYPE}-wiki'
else:
    RR_MODEL_NAME_BERT_WIKI = f'rr-{BERT_TYPE}-{QUERY_TYPE_WIKI}-wiki'
RELEVANCE_SCORE_DIR_NAME_WIKI = RR_MODEL_NAME_BERT_WIKI
...
RR_RECORD_DIR_NAME_BERT_WIKI = RR_RECORD_DIR_NAME_PATTERN.format(RR_MODEL_NAME_BERT_WIKI, FILTER_VAR, FILTER) #########################################################
...
RR_TUNE_DIR_NAME_BERT_WIKI = f'rr_tune-{RR_MODEL_NAME_BERT_WIKI}' #####################################################################################################
RR_FINER_TUNE_DIR_NAME_BERT_WIKI = f'rr_finer_tune-{RR_MODEL_NAME_BERT_WIKI}' #########################################################################################

#######################################################################################################################################################################
# FOLLOWING PART: UNILM
#######################################################################################################################################################################
"""
